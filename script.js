  ...
  users: [
    {
      ...
      ratings: [5, 5, 5],
      comments: ["Such a classic", "Gripping", "Enlightening"],
      picture: "img/blank-profile-picture.png",
    },
    {
      username: "Bibliophile255",
      firstName: "John",
      lastName: "Smith",
      createDate: "03/04/2015",
      booksReviewed: ["Dracula", "Pride and Prejudice"],
      ratings: [4, 5],
      comments: ["Spooky", "Classic romance"],
      picture: "img/blank-profile-picture.png",
    },
    {
      username: "IHeartBooks",
      firstName: "Jane",
      lastName: "Doe",
      createDate: "07/02/2016",
      booksReviewed: [
        "Pride and Prejudice",
      ...
      comments: [
        "Lovely",
        "Fly you fools",
        "This book helped me achieve enlightenment",
      ],
      picture: "img/blank-profile-picture.png",
    },
    {
      username: "Frankie_Cave",
      firstName: "Frankie",
      lastName: "Cave",
      createDate: "11/01/2020",
      booksReviewed: [
        "To Kill a Mockingbird",
        "To Sleep in a Sea of Stars",
        "The Fellowship of the Ring",
      ],
      comments: ["Required reading!", "Gripping", "Sam <3"],
      ratings: [5, 5, 5],
      picture: "img/blank-profile-picture.png",
    },
  ],
...
var authors = {
  authors: [
    ...
    },
    {
      ...
      authorState: "California",
      authorCountry: "USA",
    },
    {
      authorFirstName: "Herman",
      authorLastName: "Hesse",
      authorCity: "Calw",
      authorState: "Baden-Württemberg",
      authorCountry: "Germany",
    },
    {
      authorFirstName: "Hilda",
      authorLastName: "Rosner",
      authorCity: "NULL",
      authorState: "NULL",
      authorCountry: "NULL",
    },
    {
      ...
      authorCity: "Steventon",
      authorState: "Hampshire",
    ...
    },
    {
      ...
      authorCity: "Bloemfontein",
      authorState: "Free State",
